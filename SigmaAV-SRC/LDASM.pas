...
const
 ...
 (
  ...
  OP_NONE,                      // D6
  OP_NONE,                      // D7
  OP_MODRM or OP_WORD,          // D8
  OP_MODRM or OP_WORD,          // D9
  OP_MODRM or OP_WORD,          // DA
  OP_MODRM or OP_WORD,          // DB
  OP_MODRM or OP_WORD,          // DC
  OP_MODRM or OP_WORD,          // DD
  OP_MODRM or OP_WORD,          // DE
  OP_MODRM or OP_WORD,          // DF
  OP_DATA_I8,                   // E0
  OP_DATA_I8,                   // E1
  OP_DATA_I8,                   // E2
  OP_DATA_I8,                   // E3
...
begin
 ...
 if cPtr^ = $0F then
  ...
  end else Flags := OpcodeFlags[cPtr^];
 Inc(cPtr);
 ...
 if (Flags and OP_MODRM) > 0 then
  begin
   ...
   case iMod of
     0: if PFX67 and (iRM = 6) then OffsetSize := 2 else if iRM = 5 then OffsetSize := 4;
     1: OffsetSize := 1;
